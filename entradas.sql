...
--
-- Servidor: localhost
-- Tiempo de generación: 01-03-2018 a las 08:18:04
...
CREATE TABLE IF NOT EXISTS `entradas` (
  ...
  `titulo` varchar(300) COLLATE utf8_spanish_ci DEFAULT NULL,
  `texto` mediumtext COLLATE utf8_spanish_ci,
  `imagen` mediumblob,
  `descripcion_img` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `entradas` (`id_entrada`, `fecha`, `titulo`, `texto`, `imagen`, `descripcion_img`) VALUES
(7, '2018-02-22', 'el fondo social europeo financia cursos muy interesantes', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.\r\n				', 0x6575726f70656f726564756369646f2e6a7067, 'europeo'),
(9, '2018-02-23', 'ENTRADA DE BLOG CON IMAGEN DE FONDO VERDE', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x666f6e646f76657264652e6a7067, 'verde'),
(10, '2018-02-22', 'entrada de blog para saber que tipografía tiene un texto ', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x666f6e742e6a7067, 'letras'),
(12, '2018-02-23', 'las imágenes de muestra de windows nos pueden servir para rellenar ', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x4368727973616e7468656d756d2e6a7067, 'crisantemo'),
(13, '2018-02-23', 'el faro, otra imagen de muestra', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x4c69676874686f7573652e6a7067, 'faro'),
(14, '2018-02-24', 'portada del curso programa tic', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x706f72746164612e6a7067, 'portada del curso programa tic'),
(15, '2018-02-25', 'la importancia de los colores según su uso', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x666f6e646f656e74726164612e6a7067, 'verde y naranja'),
(17, '2018-02-26', 'entrada nueva de blog', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.\r\n\r\nExpetenda tincidunt in sed, ex partem placerat sea, porro commodo ex eam. His putant aeterno interesset at. Usu ea mundi tincidunt, omnium virtute aliquando ius ex. Ea aperiri sententiae duo. Usu nullam dolorum quaestio ei, sit vidit facilisis ea. Per ne impedit iracundia neglegentur. Consetetur neglegentur eum ut, vis animal legimus inimicus id.\r\n\r\nHis audiam deserunt in, eum ubique voluptatibus te. In reque dicta usu. Ne rebum dissentiet eam, vim omnis deseruisse id. Ullum deleniti vituperata at quo, insolens complectitur te eos, ea pri dico munere propriae. Vel ferri facilis ut, qui paulo ridens praesent ad. Possim alterum qui cu. Accusamus consulatu ius te, cu decore soleat appareat usu.\r\n\r\nEst ei erat mucius quaeque. Ei his quas phaedrum, efficiantur mediocritatem ne sed, hinc oratio blandit ei sed. Blandit gloriatur eam et. Brute noluisse per et, verear disputando neglegentur at quo. Sea quem legere ei, unum soluta ne duo. Ludus complectitur quo te, ut vide autem homero pro.\r\n\r\nVis id minim dicant sensibus. Pri aliquip conclusionemque ad, ad malis evertitur torquatos his. Has ei solum harum reprimique, id illum saperet tractatos his. Ei omnis soleat antiopam quo. Ad augue inani postulant mel, mel ea qualisque forensibus.', 0x48796472616e676561732e6a7067, 'hortensias');
--
-- Base de datos: `colegio2`
--
CREATE DATABASE `colegio2` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `colegio2`;
...
CREATE TABLE IF NOT EXISTS `curso` (
  `id_alumno` int(100) NOT NULL AUTO_INCREMENT,
  ...
  `evaluacion1` decimal(5,2) DEFAULT NULL,
  `evaluacion2` decimal(5,2) DEFAULT NULL,
  `evaluacion3` decimal(5,2) DEFAULT NULL,
  `profesor` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `curso` (`id_alumno`, `nombre`, `apellido1`, `apellido2`, `localidad`, `telefono`, `dni`, `evaluacion1`, `evaluacion2`, `evaluacion3`, `profesor`) VALUES
(2, 'Pedro', 'Gomez', 'Martinez', 'Madrid', '673698712', '05313433J', '5.00', '5.00', '5.00', 'Rebeca'),
(1, 'Luis', 'Saiz', 'Mora', 'Cuenca', '637456080', '04614387P', '6.00', '8.40', '5.00', 'Rebeca'),
(3, 'Sara', 'Herraiz', 'Moreno', 'Cuenca', '678910388', '05413788X', '1.00', '2.00', '3.00', 'Rebeca'),
(4, 'Francisco', 'Nuñez', 'Martinez', 'Albacete', '642473597', '04632878L', '1.00', '3.50', '5.00', 'Rebeca'),
(5, 'Pilar', 'Alvarez', 'Blasco', 'Toledo', '678913488', '04614343B', '7.40', '8.90', '9.30', 'Rebeca'),
(6, 'Ana', 'Martinez', 'Vazquez', 'Cuenca', '642967729', '04624893C', '4.25', '5.05', '7.00', 'Rebeca'),
(7, 'Juan', 'Alvarez', 'Fernandez', 'Huelva', '632487731', '04326731J', '10.00', '9.00', '8.00', 'Rebeca'),
(8, 'Jesus', 'Lopez', 'Jimenez', 'Madrid', '675422721', '04640770D', '5.00', '5.00', '5.00', 'Rebeca'),
(9, 'Andrea', 'Sánchez', 'Martín', 'Murcia', '642661435', '05634358B', '3.10', '4.10', '3.00', 'Rebeca'),
(10, 'Jeremy', 'López', 'Martínez', 'Albacete', '633395046', '04720680C', '10.00', '6.00', '7.50', 'Manuel'),
(11, 'Miriam', 'Gonzalez', 'Toledo', 'Toledo', '654989336', '04617654S', '5.00', '6.00', '7.00', 'Manuel'),
(12, 'Daniel', 'Sánchez', 'Hidalgo', 'Toledo', '626798326', '04563651B', '6.60', '8.00', '9.00', 'Manuel'),
(13, 'Pedro', 'Ramírez', 'Muñoz', 'Pamplona', '689160783', '05640078N', '7.50', '6.50', '4.50', 'Manuel'),
(14, 'Marta', 'Martínez', 'Collados', 'Madrid', '654509211', '52322512Y', '5.00', '5.00', '5.00', 'Manuel'),
(15, 'Pedro', 'Gutierrez', 'Gutierrez', 'Albacete', '692369612', '05926739B', '2.70', '3.75', '4.80', 'Manuel'),
(16, 'Juan', 'Lopez', 'Garrido', 'Barcelona', '684273144', '04253223J', '1.00', '1.00', '1.00', 'Manuel'),
(17, 'Irene', 'Lorca', 'Garcia', 'Salamanca', '652425632', '04123568G', '1.00', '1.00', '1.00', 'Manuel'),
(18, 'Luis', 'Torralba', 'Rodriguez', 'Cuenca', '632548759', '04512368F', '4.50', '8.20', '6.70', 'Manuel');
--
...
(NULL, 'blog', 'entradas', 'id_entrada', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'blog', 'entradas', 'fecha', 2, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'blog', 'entradas', 'titulo', 3, NULL, 'YES', 'varchar', 300, 900, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
(NULL, 'blog', 'entradas', 'texto', 4, NULL, 'YES', 'mediumtext', 16777215, 16777215, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
(NULL, 'blog', 'entradas', 'imagen', 5, NULL, 'YES', 'mediumblob', 16777215, 16777215, NULL, NULL, NULL, NULL, 'mediumblob', '', '', 'select,insert,update,references', ''),
(NULL, 'blog', 'entradas', 'descripcion_img', 6, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'id_alumno', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'nombre', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'apellido1', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'apellido2', 4, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'localidad', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'telefono', 6, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'dni', 7, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(15)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'evaluacion1', 8, NULL, 'YES', 'decimal', NULL, NULL, 5, 2, NULL, NULL, 'decimal(5,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'evaluacion2', 9, NULL, 'YES', 'decimal', NULL, NULL, 5, 2, NULL, NULL, 'decimal(5,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'evaluacion3', 10, NULL, 'YES', 'decimal', NULL, NULL, 5, 2, NULL, NULL, 'decimal(5,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'colegio2', 'curso', 'profesor', 11, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'sorteotv', 'formulario', 'id_participante', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'nombre', 2, NULL, 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(60)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'localidad', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'tlf', 4, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'email', 5, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'domicilio', 6, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'sorteotv', 'formulario', 'dni', 7, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish_ci', 'varchar(30)', '', '', 'select,insert,update,references', '');
...
('OPEN_FILES', '24'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '26'),
('OPEN_TABLES', '11'),
('OPENED_FILES', '511'),
('OPENED_TABLE_DEFINITIONS', '26'),
('OPENED_TABLES', '44'),
...
('RAND_SEED1', ''),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DELL-slow.log'),
...
('THREAD_STACK', '262144'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DELL.log'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DELL.pid'),
('EXPIRE_LOGS_DAYS', '0'),
('NAMED_PIPE', 'OFF'),
...
(NULL, 'blog', 'PRIMARY', NULL, 'blog', 'entradas', 'id_entrada', 1, NULL, NULL, NULL, NULL),
(NULL, 'colegio2', 'id_alumno', NULL, 'colegio2', 'curso', 'id_alumno', 1, NULL, NULL, NULL, NULL),
(NULL, 'colegio2', 'dni', NULL, 'colegio2', 'curso', 'dni', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'sorteotv', 'PRIMARY', NULL, 'sorteotv', 'formulario', 'id_participante', 1, NULL, NULL, NULL, NULL),
(NULL, 'sorteotv', 'nombre', NULL, 'sorteotv', 'formulario', 'nombre', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, NULL, '', '', NULL),
(NULL, 'blog', 'entradas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 1884, 15072, 281474976710655, 2048, 0, '2018-02-26 09:52:33', '2018-02-28 11:02:49', NULL, NULL, '', '', NULL),
(NULL, 'colegio2', 'curso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 18, 76, 1388, 281474976710655, 3072, 20, '2018-02-16 09:08:02', '2018-02-16 11:58:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 440, 1320, 123848989752688639, 5120, 0, '2010-11-03 15:22:43', '2018-03-01 09:17:31', '2010-11-03 15:22:44', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 452, 197, 89044, 55450570411999231, 16384, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 993, 9, 8937, 2533274790395903, 17408, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 506, 847, 428880, 281474976710655, 20480, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 62, 248, 281474976710655, 2048, 0, '2010-11-03 15:22:43', '2018-03-01 09:17:27', NULL, NULL, '', '', NULL),
(NULL, 'sorteotv', 'formulario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 112, 240, 281474976710655, 3072, 128, '2018-02-19 10:37:37', '2018-02-20 12:13:54', NULL, NULL, '', '', NULL);
...
(34, 'root', 'localhost:49519', 'colegio2', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'blog', 'utf8', 'utf8_spanish_ci', NULL),
(NULL, 'colegio2', 'utf8', 'utf8_spanish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'sorteotv', 'utf8', 'utf8_spanish_ci', NULL);
...
('''ejeblog''@''localhost''', NULL, 'blog', 'SELECT', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'INSERT', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'UPDATE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'DELETE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'CREATE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'DROP', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'REFERENCES', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'INDEX', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'ALTER', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'CREATE TEMPORARY TABLES', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'LOCK TABLES', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'EXECUTE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'CREATE VIEW', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'SHOW VIEW', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'CREATE ROUTINE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'ALTER ROUTINE', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'EVENT', 'NO'),
('''ejeblog''@''localhost''', NULL, 'blog', 'TRIGGER', 'NO'),
('''''@''%''', NULL, 'test', 'SELECT', 'NO'),
('''''@''%''', NULL, 'test', 'INSERT', 'NO'),
('''''@''%''', NULL, 'test', 'UPDATE', 'NO'),
('''''@''%''', NULL, 'test', 'DELETE', 'NO'),
...
(NULL, 'blog', 'entradas', 0, 'blog', 'PRIMARY', 1, 'id_entrada', 'A', 8, NULL, NULL, '', 'BTREE', ''),
(NULL, 'colegio2', 'curso', 0, 'colegio2', 'id_alumno', 1, 'id_alumno', 'A', 18, NULL, NULL, '', 'BTREE', ''),
(NULL, 'colegio2', 'curso', 0, 'colegio2', 'dni', 1, 'dni', 'A', 18, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'mysql', 'db', 0, 'mysql', 'PRIMARY', 3, 'User', 'A', 3, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'sorteotv', 'formulario', 0, 'sorteotv', 'PRIMARY', 1, 'id_participante', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'sorteotv', 'formulario', 0, 'sorteotv', 'nombre', 1, 'nombre', 'A', 1, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2018-03-01 09:18:04', '2018-03-01 09:18:04', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'blog', 'entradas', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 1884, 15072, 281474976710655, 2048, 0, 18, '2018-02-26 09:52:33', '2018-02-28 11:02:49', NULL, 'utf8_spanish_ci', NULL, '', ''),
(NULL, 'colegio2', 'curso', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 18, 76, 1388, 281474976710655, 3072, 20, 20, '2018-02-16 09:08:02', '2018-02-16 11:58:32', NULL, 'utf8_spanish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 3, 440, 1320, 123848989752688639, 5120, 0, NULL, '2010-11-03 15:22:43', '2018-03-01 09:17:31', '2010-11-03 15:22:44', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 452, 197, 89044, 55450570411999231, 16384, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 993, 9, 8937, 2533274790395903, 17408, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 506, 847, 428880, 281474976710655, 20480, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2010-11-03 15:22:43', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2010-11-03 15:22:44', '2010-11-24 15:00:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 62, 248, 281474976710655, 2048, 0, NULL, '2010-11-03 15:22:43', '2018-03-01 09:17:27', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'sorteotv', 'formulario', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 112, 240, 281474976710655, 3072, 128, 5, '2018-02-19 10:37:37', '2018-02-20 12:13:54', NULL, 'utf8_spanish_ci', NULL, '', '');
...
(NULL, 'blog', 'PRIMARY', 'blog', 'entradas', 'PRIMARY KEY'),
(NULL, 'colegio2', 'id_alumno', 'colegio2', 'curso', 'UNIQUE'),
(NULL, 'colegio2', 'dni', 'colegio2', 'curso', 'UNIQUE'),
...
(NULL, 'sorteotv', 'PRIMARY', 'sorteotv', 'formulario', 'PRIMARY KEY'),
(NULL, 'sorteotv', 'nombre', 'sorteotv', 'formulario', 'UNIQUE');
...
('''ejeblog''@''localhost''', NULL, 'SELECT', 'YES'),
('''ejeblog''@''localhost''', NULL, 'INSERT', 'YES'),
('''ejeblog''@''localhost''', NULL, 'UPDATE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'DELETE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'CREATE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'DROP', 'YES'),
('''ejeblog''@''localhost''', NULL, 'RELOAD', 'YES'),
('''ejeblog''@''localhost''', NULL, 'SHUTDOWN', 'YES'),
('''ejeblog''@''localhost''', NULL, 'PROCESS', 'YES'),
('''ejeblog''@''localhost''', NULL, 'FILE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'REFERENCES', 'YES'),
('''ejeblog''@''localhost''', NULL, 'INDEX', 'YES'),
('''ejeblog''@''localhost''', NULL, 'ALTER', 'YES'),
('''ejeblog''@''localhost''', NULL, 'SHOW DATABASES', 'YES'),
('''ejeblog''@''localhost''', NULL, 'SUPER', 'YES'),
('''ejeblog''@''localhost''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''ejeblog''@''localhost''', NULL, 'LOCK TABLES', 'YES'),
('''ejeblog''@''localhost''', NULL, 'EXECUTE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'REPLICATION SLAVE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'REPLICATION CLIENT', 'YES'),
('''ejeblog''@''localhost''', NULL, 'CREATE VIEW', 'YES'),
('''ejeblog''@''localhost''', NULL, 'SHOW VIEW', 'YES'),
('''ejeblog''@''localhost''', NULL, 'CREATE ROUTINE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'ALTER ROUTINE', 'YES'),
('''ejeblog''@''localhost''', NULL, 'CREATE USER', 'YES'),
('''ejeblog''@''localhost''', NULL, 'EVENT', 'YES'),
('''ejeblog''@''localhost''', NULL, 'TRIGGER', 'YES'),
...
('localhost', 'blog', 'ejeblog', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
('localhost', 'ejeblog', '*E573E68F58D6472B70E6E97511262261F1E4B220', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
--
-- Base de datos: `sorteotv`
--
CREATE DATABASE `sorteotv` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `sorteotv`;
...
INSERT INTO `formulario` (`id_participante`, `nombre`, `localidad`, `tlf`, `email`, `domicilio`, `dni`) VALUES
(4, 'David Delgado de la Torre', 'Cuenca', '674563290', 'cuencatic@gmail.com', 'C/Jorge Torner', '045678943');
